import { CalendarCheck, CalendarX, Plane, PowerOff } from 'lucide-react'
...
const cards = [
  ...
  { key: 'permit', label: 'Izin/Cuti', icon: Plane, color: 'text-violet-700', bg: 'bg-violet-100' },
  { key: 'absent', label: 'Tidak Hadir', icon: CalendarX, color: 'text-red-600', bg: 'bg-red-100' },
  { key: 'off', label: 'Off', icon: PowerOff, color: 'text-slate-600', bg: 'bg-slate-200' },
] as const
